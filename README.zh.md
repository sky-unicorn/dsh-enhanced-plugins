...
- **版本对应：** 插件 `2.5.0` 对应 DSH `0.1.2-alpha.5`，源码基线 commit 为 `49a606bc5b5934603f22a26957a07dc799ab0291`；插件发布 tag 为 `2.5.0/0.1.2-alpha.5`。聚合包、7 个独立功能包和 Windows Launcher 均使用 `2.5.0`。
