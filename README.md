...
- **Version pairing:** plugin `4.1.4` targets DSH `0.1.3-alpha.1`, source commit `d347e703908d0406b7a7ef80e3a0e594d86b2215`; its compatibility label is `4.1.4/dsh-0.1.3-alpha.1`. The aggregate, all seven standalone bundles, and Windows Launcher use `4.1.4`.
