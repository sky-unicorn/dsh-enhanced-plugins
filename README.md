...
- This repository is verified against DSH [`0.1.2-alpha.2`](https://github.com/deepseek-ai/deepseek-harness/tree/0a53fb55bea101816fa226bb964ae2bed71c343b), with local ABI baseline commit `0a53fb55bea101816fa226bb964ae2bed71c343b`.
...
- **Version pairing:** plugin `0.3.0` targets DSH `0.1.2-alpha.2`, source commit `0a53fb55bea101816fa226bb964ae2bed71c343b`; its release tag is `0.3.0/dsh-0.1.2-alpha.2`. The aggregate, all seven standalone bundles, and Windows Launcher use `0.3.0`.
...
- **Current interfaces:** Client features use `client-store`, `ui-session`, `ui-chat`, and public Remotes, without the removed `dsh-client-runtime`, `connection.api`, or `hostDescription`. Host settings owners pass validated namespace literals and use `SettingsProvider.installSection()` from the alpha.2 seam. Some online cookbook examples still reference older APIs; this project follows the public interfaces of the source commit above.
