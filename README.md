...
Plugin `6.1.0` supports exactly DSH `0.1.5-alpha.2` and `0.1.5-rc.1`. Source baselines: `b2e3b2a0125854567a4a5fcba75782e42fe84901` and `2377c272a8e839e0a84c9f0e623b867a1dce2014`, respectively. The existing release tag is `6.1.0/dsh-0.1.5-alpha.2`; use the updated source for dual-version support.
...
- Supported DSH source baselines: [`0.1.5-alpha.2`](https://github.com/deepseek-ai/deepseek-harness/tree/b2e3b2a0125854567a4a5fcba75782e42fe84901) and [`0.1.5-rc.1`](https://github.com/deepseek-ai/deepseek-harness/tree/2377c272a8e839e0a84c9f0e623b867a1dce2014). Other releases are not included in the compatibility declaration.
...
- **Version pairing:** plugin `6.1.0` supports DSH `0.1.5-alpha.2` and `0.1.5-rc.1`, at the source baselines listed above. The aggregate, all seven standalone bundles, and Windows Launcher use `6.1.0`.
