...
- **Version pairing:** plugin `2.5.0` targets DSH `0.1.2-alpha.5`, source commit `49a606bc5b5934603f22a26957a07dc799ab0291`; its release tag is `2.5.0/0.1.2-alpha.5`. The aggregate, all seven standalone bundles, and Windows Launcher use `2.5.0`.
