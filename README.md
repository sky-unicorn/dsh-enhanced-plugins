...
- **Version pairing:** plugin `3.1.3` targets DSH `0.1.2-rc.1`, source commit `76fda729799fe9b3848dbe2c211d4b231032b81e`; its release tag is `3.1.3/0.1.2-rc.1`. The aggregate, all seven standalone bundles, and Windows Launcher use `3.1.3`.
