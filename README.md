...
### 7.1.0 launch modes and compatibility

Plugin `7.1.0` supports exactly DSH `0.1.6-alpha.1` at source commit `0d1f50007f9bca3f52b06e1c3074fa14d5fb0720`. Release tag: `7.1.0/dsh-0.1.6-alpha.1(0d1f50007f)`.
...
- Supported DSH source baseline: [`0.1.6-alpha.1`](https://github.com/deepseek-ai/deepseek-harness/tree/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720). Other releases are not included in the compatibility declaration.
...
- **Version pairing:** plugin `7.1.0` supports DSH `0.1.6-alpha.1` at the source baseline listed above. The aggregate, all seven standalone bundles, and Windows Launcher use `7.1.0`.
